 ...
 */
public class AdVideoPlayer extends RelativeLayout implements VideoAdPlayer {
	...
	public AdVideoPlayer(Context context, AttributeSet attrs, int defStyle) {
...
//		videoLayouyParams.addRule(RelativeLayout.CENTER_IN_PARENT);
		videoLayouyParams.addRule(RelativeLayout.ALIGN_PARENT_TOP, RelativeLayout.TRUE);
		videoLayouyParams.addRule(RelativeLayout.ALIGN_PARENT_BOTTOM, RelativeLayout.TRUE);
		videoLayouyParams.addRule(RelativeLayout.ALIGN_PARENT_LEFT, RelativeLayout.TRUE);
		videoLayouyParams.addRule(RelativeLayout.ALIGN_PARENT_RIGHT, RelativeLayout.TRUE);
	...
	public void setLoadingIndicator(ImageView loadingIndicator) { // Added by RenZhe Ahn
		video.setLoadingIndicator(loadingIndicator);
	}
	
	public void stopLoadingIndicator() { // Added by RenZhe Ahn
		video.stopLoadingIndicator();
	}
